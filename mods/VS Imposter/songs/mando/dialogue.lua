local Turnos = {'dad', 'bf', 'gf', 'dad','gf','dad','bf','dad','dad','dad','gf','dad','bf','dad','bf'}
local TurnosNombres = {'Yellow', 'Boyfriend', 'Girlfriend', 'Yellow','Girlfriend','Yellow','Boyfriend','Yellow','Yellow','Yellow','Girlfriend','Yellow','Boyfriend','Yellow','Boyfriend'}
local Emociones = {'happy', 'neutral', 'suspect', 'happy', 'suspect', 'skeptical', 'neutral', 'what', 'skeptical','neutral','neutral','happy','neutral','happy','happy'}
local Numero = 1
local NumeroI2 = 0
...
"i mean like, every person weve ran into so far turned out to be an impostor and killed us....",
"oh.",
"thats racist i feel like",
"not all among us are the same",
"yk what your're right we're sorry",
