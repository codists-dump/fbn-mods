local Turnos = {'bf', 'gf', 'dad', 'bf','dad','gf','dad','dad','dad','bf','dad'}
local TurnosNombres = {'Boyfriend', 'Girlfriend', 'Green', 'Boyfriend','Green','Girlfriend','Green','Green','Green','Boyfriend','Green'}
local Emociones = {'neutral', 'neutral', 'excite', 'neutral','excite','suspect','nervous','threat','nervous','happy','happy'}
local Numero = 1
local NumeroI2 = 0
local NumeroFinal = 12
...
'Come on.',
'Cant you hear how you sound? You are OUT OF YOUR DAMN MIND.',
'sure man',
...
addAnimationByPrefix('Portraitbf', 'realization', 'realization', 24, false);
...
makeAnimatedLuaSprite('Portraitdad', 'Stages/dialogueV4/green', 240, 255);
addAnimationByPrefix('Portraitdad', 'happy', 'GC happy', 24, false);  
addAnimationByPrefix('Portraitdad', 'excited', 'GC excited', 24, false);
addAnimationByPrefix('Portraitdad', 'nervous', 'GC nervous', 24, false);
addAnimationByPrefix('Portraitdad', 'threat', 'GC threatening', 24, false);
addAnimationByPrefix('Portraitdad', 'q', 'q', 24, false);
...
addAnimationByPrefix('dialogueBox', 'dad', 'dad2', 24, false);
addAnimationByPrefix('dialogueBox', 'yellow', 'dad3', 24, false);
...
addAnimationByPrefix('icon1', 'dad', 'green', 24, false);
...
addAnimationByPrefix('icon2', 'dad', 'green', 24, false);
