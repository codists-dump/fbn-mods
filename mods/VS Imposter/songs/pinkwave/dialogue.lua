local Turnos = {'dad', 'bf', 'dad', 'gf','bf','bf','dad','dad'}
local TurnosNombres = {'Pink', 'Boyfriend', 'Pink', 'Girlfriend','Boyfriend','Boyfriend','Pink','Pink'}
local Emociones = {'excited', 'neutral', 'happy', 'suspect','neutral','neutral','neutral','neutral'}
local Numero = 1
local NumeroI2 = 0
local NumeroFinal = 9
