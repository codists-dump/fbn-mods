local Turnos = {'dad', 'dad', 'bf', 'dad','gf','gf','dad','bf','dad','bf','dad','bf','dad'}
local TurnosNombres = {'Pink', 'Pink', 'Boyfriend', 'Pink','Girlfriend','Girlfriend','Pink','Boyfriend','Pink','Boyfriend','Pink','Boyfriend','Pink'}
local Emociones = {'sad', 'neutral', 'happy', 'excited','neutral','suspect','happy','neutral','happy','neutral','excited','happy','excited'}
local Numero = 1
local NumeroI2 = 0
...
'i wonder when ill finally make a friend....',
...
makeAnimatedLuaSprite('Portraitdad', 'Stages/dialogueV4/pink', 240, 215);
...
addAnimationByPrefix('dialogueBox', 'dad', 'dad7', 24, false);
...
addAnimationByPrefix('icon1', 'dad', 'pink', 24, false);
...
addAnimationByPrefix('icon2', 'dad', 'pink', 24, false);
