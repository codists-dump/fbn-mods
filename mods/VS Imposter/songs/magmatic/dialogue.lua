local Turnos = {'dad', 'bf', 'bf', 'dad','bf','dad'}
local TurnosNombres = {'Maroon', 'Boyfriend', 'Boyfriend', 'Maroon','Boyfriend','Maroon'}
local Emociones = {'neutral', 'angry', 'mad', 'happy', 'angry', 'neutral'}
local Numero = 1
local NumeroI2 = 0
local NumeroFinal = 7
