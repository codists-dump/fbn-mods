local Turnos = {'dad', 'bf', 'gf', 'gf','gf','bf','bf','dad','gf','gf','dad','bf','dad','dad','bf'}
local TurnosNombres = {'Red', 'Boyfriend', 'Girlfriend', 'Girlfriend','Girlfriend','Boyfriend','Boyfriend','Red','Girlfriend','Girlfriend','Red','Boyfriend','Red','Red','Boyfriend'}
local Emociones = {'sad', 'neutral', 'suspect', 'suspect', 'q', 'neutral', 'q', 'sad', 'happy','mad','mad','happy','happy','happy','neutral'}
local Numero = 1
local NumeroI2 = 0
local NumeroFinal = 16
