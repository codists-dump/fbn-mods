local Turnos = {'dad', 'bf', 'dad', 'gf','bf','dad','bf','dad'}
local TurnosNombres = {'White', 'Boyfriend', 'White', 'Girlfriend','Boyfriend','White','Boyfriend','White'}
local Emociones = {'happy', 'angry', 'pissed', 'neutral','happy','insane','happy','disappointed'}
local Numero = 1
local NumeroI2 = 0
local NumeroFinal = 9
...
makeAnimatedLuaSprite('Portraitdad', 'Stages/dialogueV4/whitee', 240, 255);
addAnimationByPrefix('Portraitdad', 'disappointed', 'disappointed', 24, false);  
addAnimationByPrefix('Portraitdad', 'happy', 'happy', 24, false);  
addAnimationByPrefix('Portraitdad', 'excited', 'excited', 24, false);
addAnimationByPrefix('Portraitdad', 'upset', 'happy', 24, false);
addAnimationByPrefix('Portraitdad', 'insane', 'insanity', 24, false);
addAnimationByPrefix('Portraitdad', 'pissed', 'pissed', 24, false);
...
addAnimationByPrefix('dialogueBox', 'dad', 'dad4', 24, false);
...
addAnimationByPrefix('icon1', 'dad', 'white', 24, false);
...
addAnimationByPrefix('icon2', 'dad', 'white', 24, false);
