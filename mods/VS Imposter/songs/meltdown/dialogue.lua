local Turnos = {'bf', 'gf', 'dad', 'gf','bf','dad','dad','bf','bf','dad','bf'}
local TurnosNombres = {'Boyfriend', 'Girlfriend', 'Red', 'Girlfriend','Boyfriend','Red','Red','Boyfriend','Boyfriend','Red','Boyfriend'}
local Emociones = {'happy', 'happy', 'nervous', 'glint','angry','sad','sad','happy','mad','happy','neutral'}
local Numero = 1
local NumeroI2 = 0
...
function onEndSong()
if isStoryMode and not Papu then
