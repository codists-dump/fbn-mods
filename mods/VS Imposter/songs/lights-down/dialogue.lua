local Turnos = {'dad', 'gf', 'dad', 'bf','dad','dad','dad','bf','dad'}
local TurnosNombres = {'Green', 'Girlfriend', 'Green', 'Boyfriend','Green','Green','Green','Boyfriend','Green'}
local Emociones = {'neutral', 'neutral', 'upset', 'happy','neutral','neutral','happy','happy','upset'}
local Numero = 1
local NumeroI2 = 0
...
addAnimationByPrefix('Portraitdad', 'happy', 'GI happy', 24, false);  
addAnimationByPrefix('Portraitdad', 'neutral', 'GI neutral', 24, false);
addAnimationByPrefix('Portraitdad', 'upset', 'GI upset', 24, false);
...
addAnimationByPrefix('icon1', 'dad', 'greenI', 24, false);
...
addAnimationByPrefix('icon2', 'dad', 'greenI', 24, false);
