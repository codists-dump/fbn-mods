local Turnos = {'dad', 'dad', 'bf', 'bf','bf','bf','bf','bf','bf','bf','bf','dad','bf'}
local TurnosNombres = {'Red', 'Red', 'Boyfriend', 'Boyfriend','Boyfriend','Boyfriend','Boyfriend','Boyfriend','Boyfriend','Boyfriend','Boyfriend','Red','Boyfriend'}
local Emociones = {'happy', 'happy', 'realization', 'realization', 'sad', 'sad', 'sad', 'angry', 'mad','mad','sad','neutral','happy'}
local Numero = 1
local NumeroI2 = 0
local NumeroFinal = 14
...
makeAnimatedLuaSprite('Portraitdad', 'Stages/dialogueV4/red', 240, 255);
addAnimationByPrefix('Portraitdad', 'happy', 'happy', 24, false);  
addAnimationByPrefix('Portraitdad', 'mad', 'mad', 24, false);
...
addAnimationByPrefix('dialogueBox', 'dad', 'dad1', 24, false);
addAnimationByPrefix('dialogueBox', 'green', 'dad2', 24, false);
...
addAnimationByPrefix('icon1', 'dad', 'red', 24, false);
...
addAnimationByPrefix('icon2', 'dad', 'red', 24, false);
