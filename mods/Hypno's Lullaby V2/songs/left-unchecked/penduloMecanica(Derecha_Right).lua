...
function onUpdatePost(elapsed)
	...
	if active then 
       ...
       if trance > 0.5 then
		...
		if keyJustPressed('space') or (getMouseX('camHUD') > 1100 and getMouseX('camHUD') < 1250) and (getMouseY('camHUD') > 145 and getMouseY('camHUD') < 275 and mouseClicked('left')) then 
