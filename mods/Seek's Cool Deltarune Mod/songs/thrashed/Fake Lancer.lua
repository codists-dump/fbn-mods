...
idle_xml_name = 'throsh idle'
left_xml_name = 'throsh left'
down_xml_name = 'throsh down'
up_xml_name = 'throsh up'
right_xml_name = 'throsh right'
...
name_of_character_xml = 'throsh'
name_of_character = 'throsh'
...
function onCreate()
	...
	addAnimationByPrefix(name_of_character, 'idle', idle_xml_name, 12, true);
