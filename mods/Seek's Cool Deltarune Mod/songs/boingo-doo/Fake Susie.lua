...
idle_xml_name = 'susie idle0'
left_xml_name = 'susie left0'
down_xml_name = 'susie down0'
up_xml_name = 'susie up0'
right_xml_name = 'susie right0'
...
name_of_character_xml = 'susie'
name_of_character = 'susie'
...
function onCreate()
	...
	addAnimationByPrefix(name_of_character, 'atk', 'susie atk', 12, false);
