...
--customize variables
local camOffset = 40; -- how much will it move
...
function startScript()
    oppCamX = getProperty('dad.cameraPosition[0]') + getMidpointX('dad') + 150;
    oppCamY = getProperty('dad.cameraPosition[1]') + getMidpointY('dad');
    bfCamX = getProperty('boyfriend.cameraPosition[0]') + getMidpointX('boyfriend') - 100;
