...
function startScript()
    ...
    oppCamY = getProperty('dad.cameraPosition[1]') + getMidpointY('dad') - 150;
    bfCamX = getProperty('boyfriend.cameraPosition[0]') + getMidpointX('boyfriend') - 550;
    bfCamY = getProperty('boyfriend.cameraPosition[1]') + getMidpointY('boyfriend') - 350;
    pissed = true
end
